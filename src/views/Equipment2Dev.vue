<template>
  <div class="development-view">
    ...
    <!-- 秘书舰信息区域 -->
    <!-- <div class="flagship-info" v-if="flagshipInfo">
      <div class="flagship-status" :class="{ 'warning': !isCurrentFlagshipSelected }">
        游戏当前秘书舰：{{ flagshipInfo ? `${flagshipInfo.pool.开发池名称}(${flagshipInfo.shipInfo.name})` : '无数据' }}
      </div>
    </div> -->
